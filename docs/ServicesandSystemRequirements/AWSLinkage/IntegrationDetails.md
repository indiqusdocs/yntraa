...
- **Account-level Billing** - All the usage generated on AWS will be available as an invoice on Yntraa, with the service provider as the biller.
...
- **Manage Service on AWS** - AWS account can be used and accessed from the AWS Console as usual. From Yntraa, a redirect is provided to the AWS Console.
