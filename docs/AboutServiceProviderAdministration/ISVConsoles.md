...
A standard Yntraa deployment includes the following ISVs on which, service provider teams have restricted access:
...
:::note
Restricted access is provided as any modifications done on the ISV systems can severely impact the quality of service and the experience delivered via Yntraa.
:::
