...
- **Create Buckets** - Users can create buckets with unique names, following the naming convention mentioned on Yntraa cloud platform.
- **Add Objects** -  Users can add objects to their respective buckets using the Yntraa cloud platform.
...
- **Bucket Creation** - User can create buckets with unique names following the naming convention which is mentioned on the Yntraa cloud platform UI
- **Bucket Edit** - End user can edit the already created Buckets at any point in time by logging in to the Yntraa cloud platform UI
- **Object Creation**- Users from the Yntraa cloud platform UI itself can upload objects.
...
- **Option to Unsubscribe from the Service** - Users can easily unsubscribe from the service at any time from the Yntraa cloud platform UI only.
