...
Each Instance on Yntraa Cloud includes a root disk or volume. This is the primary disk partition on the Instance, where the operating system, data, components and files reside.
...
| Restore Point Management         | Available                       | Available  |
| Recurring Restore Point Schedules| Available                       | Available  |
