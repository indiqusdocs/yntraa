...
1. Navigate to **MANAGED COMPUTE** > **Virtual Desktops**. ![virtualdesktop](img/virtualdesktop.png)

2. Click the **ACTIVATE** button.![virtualdesktopactivation](img/virtualdesktopactivation.png)
