...
Custom OS templates can be created from a Restore Point. To view custom templates, navigate to **Tools and Utilities > My Images**. The following details are displayed:
