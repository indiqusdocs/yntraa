...
1. Navigate to **Managed Solutions > Managed Databases as a Service**. ![databasenew](img/databasenew.png)
2. Click the **Activate** button. This action opens the database provisioning request form.![databaseactivationnew.png](img/databaseactivationnew.png)
