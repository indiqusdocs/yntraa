...
1. Navigate to **CLOUD ASSURE** > **Migration Assist**.![migrationassist](img/migrationassist.png)
2. Click the **ACTIVATE** button.![migrationassistactivation](img/migrationassistactivation.png)
