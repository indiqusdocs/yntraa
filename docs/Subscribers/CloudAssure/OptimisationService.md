...
1. Navigate to **CLOUD ASSURE** > **Optimization Service**. ![optimisation](img/optimisation.png)
2. Click the **ACTIVATE** button. ![optimisationactivation](img/optimisationactivation.png)
