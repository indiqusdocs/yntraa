...
2. **[Site-to-Site VPN](/docs/Subscribers/Networking/IPv4-basedNetworking/ManagingVPNGatewaysandSite-to-SiteVPN) -** To connect a private static network to your VPC on Yntraa cloud using an IPSec tunnel. Site-to-site gateways must be pre-configured on Yntraa cloud.
