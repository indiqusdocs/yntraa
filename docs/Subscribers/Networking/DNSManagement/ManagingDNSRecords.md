...
DNS records and subdomains can be managed on Yntraa Cloud to be used with Instances, IPv4 Addresses and other workloads created on Yntraa-powered clouds. This only requires a [domain to be linked with the Apiculus nameservers](LinkingDomainstoYntraaCloud.md).
