...
![signinoneyotta](img/signinoneyotta.png)
...
## Credit Notes
![creditnotes](img/creditnotes.png)
1. From the dashboard, click on the **Commercial** tab from the left-side menu.
...
![creditvoucher1](img/creditvoucher1.png)
...
3. Click on the **Redeem Voucher** button. The following screen appears:
   ![creditvoucher2](img/creditvoucher2.png)
...
8. Click on the **Applied Vouchers** button under the Credit Voucher section. The following screen appears, showing a table of all applied vouchers with details:
   ![creditvoucher3](img/creditvoucher3.png)
- Voucher Code
- Microsite
- Currency
- Amount
...
## Discount Codes
![discountcode](img/discountcode.png)
...
![paymenthistory](img/paymenthistory.png)
...
## Service Balance
![servicebalance](img/servicebalance.png)
