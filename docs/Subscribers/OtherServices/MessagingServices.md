...
1. Navigate to **OTHER SERVICES** > **Messaging Services**. ![messagingservice](img/messagingservice.png)
2. Click the **ACTIVATE** button. ![messagingserviceactivation.png](img/messagingserviceactivation.png)
...
## Accessing Messaging Service Details
