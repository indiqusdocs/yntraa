...
1. Navigate to **OTHER SERVICES** > **Security Testing**. ![securitytesting](img/securitytesting.png)
2. Click the **ACTIVATE** button. ![securitytestingactivation.png](img/securitytestingactivation.png)
