...
5. Click the **Port Forwarding Rule** icon (next to the IP address) to start adding a [port forwarding rule](/docs/Subscribers/NetworkandSecurity/NATGateways/ManagingIPAddresses).
