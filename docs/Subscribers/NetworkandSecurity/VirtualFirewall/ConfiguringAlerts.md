...
The Manage Recipients feature lets you control who receives firewall alerts. It displays all configured or added email IDs and provides options to delete outdated addresses or add new ones. 

To delete existing email IDs and add other email IDs, follow these steps.
...
5. Click the dropdown and select a recipient from the list. The following screen appears.
![Manage Recipient](imgnew/managerecepientnew.png)
6. Click the **Update** button to save the recipient list.
