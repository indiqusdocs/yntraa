...
1. **[Remote Access VPN](/docs/Subscribers/NetworkandSecurity/IPv4-basedNetworking/UsingRemoteAccessVPNwithVPC) -** To connect securely from your home or office to your VPC on Yntraa cloud. This is used primarily when you’re using a dynamic IP to connect to the internet and a VPN connection can, therefore, not be pre-configured.
2. **[Site-to-Site VPN](/docs/Subscribers/NetworkandSecurity/IPv4-basedNetworking/ManagingVPNGatewaysandSite-to-SiteVPN) -** To connect a private static network to your VPC on Yntraa cloud using an IPSec tunnel. Site-to-site gateways must be pre-configured on Yntraa cloud.
