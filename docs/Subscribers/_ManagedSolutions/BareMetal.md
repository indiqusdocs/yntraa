...
1. Navigate to **Managed Solutions** > **Bare Metal**. ![baremetal](img/baremetal.png)
2. Click the **Activate** button. ![metalactivation1.png](img/metalactivation1.png)
   ![metalactivation2.png](img/metalactivation2.png)
