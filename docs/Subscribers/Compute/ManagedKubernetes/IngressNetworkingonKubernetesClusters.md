...
This section describes managing a cluster's firewalls and ingress networking. Here, Port forwarding and load balancing rules can also be managed using `kubectl`.

To view networking, navigate to [Viewing Kubernetes Cluster Details](ViewingKubernetesClusterDetails) and select **cluster details**. 
![Kubernetes Networking](img/kubenetworking.png)
...
To add a Firewall Rule to Cluster, follow these steps:
1. Click the **ADD NETWORKING RULE** button.![Kubenetes Add Network Rule](img/kubeaddnetworkrule.png)
...
![Kubernetes Add PF Rule](img/kubeaddpfrule.png)
...
1. Click the **ADD NETWORKING RULE**  button. The following screen appears:![Kubernetes LB Rule](img/kubelbrule.png)
