...
To view ingress networking, follow the step:

Navigate to Viewing Kubernetes Cluster Details and select **Cluster Details**. 
...
1. Click the **ADD NETWORKING RULE** button.
   ![Kubenetes Add Network Rule](img/kubeaddnetworkrule.png)
...
1. Click the **ADD NETWORKING RULE**  button. The following screen appears:
   ![Kubernetes LB Rule](img/kubelbrule.png)
