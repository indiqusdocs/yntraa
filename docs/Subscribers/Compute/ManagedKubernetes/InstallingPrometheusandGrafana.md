...
```
READY   STATUS    RESTARTS alertmanager-prometheus-kube-prometheus-alertmanager-0   
2/2     Running   0 prometheus-grafana-6b8d4f6f58-abcde
3/3     Running   0 prometheus-kube-prometheus-operator-xxxxx
1/1     Running   0 prometheus-kube-state-metrics-xxxxx
