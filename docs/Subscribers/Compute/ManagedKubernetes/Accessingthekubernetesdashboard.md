...
2. Navigate to the **Kubernetes Clusters** screen, select your Kubernetes cluster, and navigate to the **Access** section. Download the `kubeconfig` file from there.
...
- **For Linux**: 
	...
	You should be able to see the following output:![outputkube2](img/outputkube2.png)
