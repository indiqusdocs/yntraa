...
1. Navigate to the **Compute > Windows Instances**.
...
Once ready, you are notified of this purchase on your email address on record. To access the  newly created Windows Instances, navigate to the **Compute > Windows Instances** on the main navigation panel.
