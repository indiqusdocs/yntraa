...
Yntraa Cloud offers a highly usable and visual way of working with and operating Windows Instances using the cloud console. All Linux Instances available in your account can be accessed in the following way:
...
- [Alerts](CreatingAlertsonWindowsInstances.md)
