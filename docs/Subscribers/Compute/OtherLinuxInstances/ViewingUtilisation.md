...
Utilisation reports provide historical usage details for your linux instance. You can view daily maximum, minimum, and average readings across all supported parameters. The utilisation table presents this information in a clear date‑wise format, and you can download the report as a .csv file for further analysis.
