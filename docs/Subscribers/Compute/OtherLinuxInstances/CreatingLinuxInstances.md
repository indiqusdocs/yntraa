...
5. Select the OS image to run on your Instance.
	- You can select customised OS image from **My Images** tab.
...
9. In the **Name Your Linux Instance** field, enter the desired name for your Linux Instance. The Instance name contains alphanumeric characters, underscore, dots and hyphens only. 
10. Verify the estimated cost of your Linux Instance based on the chosen specifications from the **Summary and Estimated Costs** Section (Here, both Hourly and Monthly Prices summary are displayed).
...
12. Choose the **Buy Hourly** or **Buy Monthly** option. A confirmation window appears and the price summary displays along with the discount codes if you have any in your account. 
...
13. Click the **Confirm** button to create the Linux Instance.
