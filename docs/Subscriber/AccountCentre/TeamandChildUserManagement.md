...
Team members or child users can be onboarded using the **TEAM** section from the Account Centre. Yntraa cloud console allows you to add billing, technical, or other admin users who can log in to your account and perform operations.
...
- **Password -** set a strong password to begin with. 
  ...
  :::note
   The child user can reset the password from the Yntraa cloud console.
  :::
...
The child user receives an email notification when their account is created. They can then login and use the **Yntraa cloud console** based on their assigned role.
