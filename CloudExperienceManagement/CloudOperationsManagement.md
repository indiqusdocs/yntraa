...
The general guidelines to follow when using the Yntraa cloud platform to manage cloud resources:

- The Cloud Console dashboard is always accessible in one click (by clicking on **Dashboard** while in the cloud management view, or by 'closing' the [Account Centre](AboutYntraaAccountCentre.md) view). This ensures that it's always easy to restart an experience.
...
- Custom links that include external knowledge bases, videos, media, and other rich information on **how to use Yntraa** are always available in the **cloud management view**. Similarly, commercial information (such as privacy policy, SLA, EULA, etc.) is always available in the **Account Centre view**. This design ensures that information is strategically provided on the Cloud Console interface.
